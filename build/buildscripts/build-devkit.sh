...
##交叉编译目标
CROSSBUILD=arm-linux-androideabi
...
if [ $VERSION -eq 1 ]; then
	...
	# targetarchives="libnds-src-${LIBNDS_VER}.tar.bz2 
		...
		targetarchives=""
				...
				#" gp32tools-$GP32_TOOLS_VER.tar.bz2 dstools-$DSTOOLS_VER.tar.bz2 grit-$GRIT_VER.tar.bz2 general-tools-$GENERAL_TOOLS_VER.tar.bz2
				#dlditool-$DLDITOOL_VER.tar.bz2 mmutil-$MMUTIL_VER.tar.bz2 dfu-util-$DFU_UTIL_VER.tar.bz2 stlink-$STLINK_VER.tar.bz2 		 3dstools-$TOOLS3DS_VER.tar.bz2 3dslink-$LINK3DS_VER.tar.bz2"
		hostarchives="gbatools-$GBATOOLS_VER.tar.bz2 ndstool-$NDSTOOL_VER.tar.bz2"
fi
...
##仅生成gbatools ndstools 其他工具需要依赖项，自行编译
